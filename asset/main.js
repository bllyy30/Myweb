...
Bg2.addEventListener('click', () => {
  darkColorLightnes = '245%';
  whiteColorLightnes = '50%';
  lightColorLightnes = '20%';
...
document.querySelector('.fcbook').addEventListener("click",function(){
  Swal.fire('Gapunya Facebook :)')
})